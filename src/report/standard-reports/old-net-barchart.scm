...
(define-module (gnucash report standard-reports old-net-barchart))
...
(define net-worth-barchart-uuid "2c2ce4fb3016426ba90452f57cdaac05")
(define income-expense-barchart-uuid "49659c26e7a74b2fafa4aa43fae16306")

;; Here we define the actual report
(gnc:define-report
 'version 1
 'name (N_ "Net Worth Barchart [original]")
...
(gnc:define-report
 'version 1
 'name (string-append reportname " [original]")
 'report-guid income-expense-barchart-uuid
 'menu-name (N_ "Income & Expense Chart [original]")
