...
(define-module (gnucash report standard-reports old-net-linechart))
...
(define net-worth-linechart-uuid "1c44c63f053b455f9232b2da4d0bdbd9")

;; Here we define the actual report
(gnc:define-report
 'version 1
 'name (N_ "Net Worth Linechart [original]")
