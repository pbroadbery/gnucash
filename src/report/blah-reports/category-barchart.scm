...
(define category-barchart-income-uuid "33e844d905614e75a76e7746af06ec0c")
(define category-barchart-expense-uuid "4931886e2b5049b6b28a6c9d5d2e813b")
(define category-barchart-asset-uuid "c50524fcf4e545ac93ae2fea8a1ee7ea")
(define category-barchart-liability-uuid "a99ce901920641118bb7c3a6035fc3ff")
...
(for-each
 ...
 (list
  ...
  (list reportname-income (list ACCT-TYPE-INCOME) #t menuname-income menutip-income (lambda (x) #t) "33e844d905614e75a76e7746af06ec0c")
  (list reportname-expense (list ACCT-TYPE-EXPENSE) #t menuname-expense menutip-expense (lambda (x) #f) "4931886e2b5049b6b28a6c9d5d2e813b")
  (list reportname-assets
        (list ACCT-TYPE-ASSET ACCT-TYPE-BANK ACCT-TYPE-CASH ACCT-TYPE-CHECKING
              ...
              ACCT-TYPE-CURRENCY)
        #f menuname-assets menutip-assets (lambda (x) #f) "c50524fcf4e545ac93ae2fea8a1ee7ea")
