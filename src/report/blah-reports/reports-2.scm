(define-module (gnucash report blah-reports reports-2))
...
(define (collector-evaluate collector)
  (define (evaluate gnc-collector)
    (gnc-collector 'format (lambda (comm value) (cons comm value)) #f))
